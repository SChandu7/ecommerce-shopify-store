                                ...
                                child: MaterialButton(
                                  onPressed: () async {
                                    ...
                                    try {
                                      ...
                                      if (response.statusCode == 200) {
                                        // Print current user before setting
                                        print(
                                          Provider.of<resource>(
                                            context,
                                            listen: false,
                                        ...
                                        // Save role (Patient / Doctor)
                                        Provider.of<resource>(
                                          context,
                                          listen: false,
                                        ).setLoginDetails2(data['role']);

                                        // Debug prints
                                        print("Full response map: $data");
                                        print(
                                          "Role from response: ${data['role']}",
                                        );

                                        // Now PresentWorkingUser should reflect latest value
                                        print(
                                          Provider.of<resource>(
                                            context,
                                            listen: false,
